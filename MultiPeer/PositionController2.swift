...
//import AVFoundation
//
//class PositionController2: UIViewController {
//
//    // MARK: - Properties
//
//
...
//        }
//
////        guard self.trialCores.count != 0 else {
//////            print("trialCOres is empty!")
////            fatalError("trialCores is empty")
////        }
//    }
//
...
//        print("moveToSubjectController called!!")
...
//
//        // trialCores not initialized for default case
////        print("trialCores: \(trialC)")
//        print("total number of trialCores: \(trialCores.count)")
//        for eachCore in trialCores {
//
//            print("core title: \(eachCore.title)")
//        }
