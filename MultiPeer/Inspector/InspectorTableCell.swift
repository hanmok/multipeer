...
// MARK: - InspectorTableCell
class InspectorTableCell: UITableViewCell {
    ...
    static let identifier = "inspectorTableCell"
...
//        imageView.image = UIImage()
        ...
        nameWithCountLabel.text = vm.inspectorName
        detailInfoLabel.text = vm.phoneNumber
    }
